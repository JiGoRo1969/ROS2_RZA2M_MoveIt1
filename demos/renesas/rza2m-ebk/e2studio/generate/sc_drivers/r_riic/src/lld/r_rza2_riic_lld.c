 ...
 */
static volatile struct st_riic *gsp_riic[RIIC_CFG_LLD_NUM_CHANNELS] = // @suppress("Composite variable usage")
{
    /* RIIC Channels */
...
* Description  : This function is called by HLD, and transfer ACK to write device.
...
* Description  : This function is called by HLD, and transfer NACK to write device.
...
* Description  : This function is called by HLD, and hold the SCL in the low level.
...
* Description  : This function is called by HLD, and release the low hold of the SCL.
...
* Description  : This function is called by HLD, and write to the data register.
...
* Description  : This function is called by HLD, and read transfer data from register.
...
* Description  : This function is called by HLD, and get detection status of STOP condition.
...
* Description  : This function is called by HLD, and start waiting slave address 
*                from master device.
*                Also, after calling this function, it is always in the stop condition 
*                standby state.
...
* Description  : This function is called by HLD, and start detecting of arbitration.
...
* Description  : This function is called by HLD, and stop detecting of arbitration.
...
* Description  : This function is called by HLD, and get slave address number of 
...
* Return Value : DRV_SUCCESS - Operation is success.
*                DRV_ERROR - Combination of frequency setting is illegal parameter.
*******************************************************************************/
static int_t riic_set_scl_clk (int_t channel, st_riic_config_t *p_cfg, uint32_t pclk)
{
    int_t retval = DRV_SUCCESS;
