...
#else
    #define ETHER_CFG_EMAC_RX_DESCRIPTORS               (32)
#endif
...
#else
    #define ETHER_CFG_EMAC_TX_DESCRIPTORS               (32)
#endif
...
Variable Externs
******************************************************************************/
#if defined(__R_ETHER_RZA2_C__)
/**
 * @section R_SCIFA_SC_CFG_80_TABLE Smart Configurator settings table.
 */
const st_r_drv_ether_sc_config_t ETHER_SC_TABLE[] =
{
...
#else
extern const st_r_drv_ether_sc_config_t ETHER_SC_TABLE[1];
#endif
