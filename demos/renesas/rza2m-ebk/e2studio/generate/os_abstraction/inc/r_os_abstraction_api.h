...
#define R_OS_ABSTRACTION_VERSION_MINOR         (1)
 ...
 * 
 * The OS Abstraction layer contains a system mutex. 
 * This function allows a user to obtain the mutex for system
 * critical usage.
 * 
 * @return None.
 */
 ...
 * 
 * The OS Abstraction layer contains a system mutex. 
 * This function allows a user to release the mutex from system
 * critical usage.
 * 
 * @return None.
 */
 ...
 * 
 *  @return    The function returns the number of ticks counted.
 */
 ...
 *
 *  @retval TRUE The message queue was successfully created
 *  @retval FALSE The message queue creation failed.
 */
bool_t R_OS_MessageQueueCreate (p_os_msg_queue_handle_t *pp_queue_handle, uint32_t queue_sz);

/** 
 *  @brief     Put a message onto a queue.
 *             Can be called from both inside and outside of an Interrupt Service Routine.
 * 
 *  @param[in] p_queue_handle pointer to queue handle.
 *  @param[in] p_message pointer to message.
 * 
 *  @return    The function returns TRUE if the message queue object was successfully added to the queue. Otherwise, FALSE is returned
 */
 ...
 *             Can only be called outside of an Interrupt Service Routine. 
 * 
 ...
 * 
 *  @return    The function returns TRUE if the message queue object was successfully retrieved from the queue. Otherwise, FALSE is returned
 */
 ...
 *  @param[in] p_os_msg_queue_handle_t pointer to queue handle.
 *  @return    The function returns TRUE if the message queue object was successfully cleared. Otherwise, FALSE is returned
 */
...
/** 
 *  @brief     Clears the state on the associated event.<br>
 *             Setting event to EV_RESET. 
 * 
 *  @param[in] pp_event Pointer to an associated event.
 * 
 *  @return    none.
...
/** 
 *  @brief     Blocks operation until one of the following occurs 
 *             A timeout occurs. 
 ...
 * 
 *  @param[in] p_info Structure containing module version information.
 * 
